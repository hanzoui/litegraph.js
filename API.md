...
In-IDE typing is available for use in at least mainstream editors. It can be added to JS projects using the @hanzoui/litegraph npm package.

```ts
/** @import { IWidget } from './path/to/@hanzoui/litegraph/litegraph.d.ts' */
/** @type IWidget */
